                ...
                <div id={'left-utils'}>
                    <div className={'util-group'} id={'left-1'}>
                        ...
                        <p className={'white-util-text'}>
                            الفبا با دقت 97% نوشته های اسناد را میخواند و با سخت افزار مناسب میتواند 20 صفحه را در هر دقیقه تحلیل کند. البته دقت نویسه خوان به کیفیت اسناد ورودی هم ربط دارد.
                        </p>
                    </div>
                    <div className={'util-group'} id={'left-2'}>
                        ...
                        <p className={'white-util-text'}>
                            الفبا میتواند با استفاده از پردازنده گرافیکی(کارت گرافیک)،اسناد را چند برابر سریع تر پردازش کند. همچنین قابلیت استفاده از چند ماشین برای پردازش توزیع شده اسناد را فراهم میکند.
                        </p>
                    </div>
                </div>
                <div id={'right-utils'}>
                    ...
                    <div className={'util-group'} id={'right-1'}>
                        ...
                        <p className={'white-util-text'}>
                            الفبا جمله های فارسی را میشناسد. یعنی گاهی وقت ها که میان دو شکل مختلف یک عبارت تردید دارد،هر دو را در میان دیگر کلمات خط نوشته قرار می دهد، تا ببیند کدام یک از جملات را بهتر کامل می کند.
                        </p>
                    </div>
                    <div className={'util-group'} id={'right-2'}>
                        ...
                        <p className={'white-util-text'}>
                            الفبا با کمک فناوری های روز دنیا یعنی یادگیری عمیق، خواندن نویسه ها را با قلم های مختلف یادگرفته است. این فناوری علاوه بر دقت بالا،امکان خواندن قلم های تازه را هم برای نویسه خوان فراهم میکند.
                        </p>
                    </div>
                </div>
            </div>
